...
void Mode_Switch(void)
{
    ...
    else
    {
        ...
        OLED_ShowStr(55, 0, "      ", 2); // 睲埃Τ陪ボ
        OLED_ShowStr(55, 0, "Open", 2);   // 陪ボ家Α跑
    }
...
void UpdateDisplay(void)
{
    ...
    if (currentMode == MODE_CLOSED_LOOP)
    {
		...
		//currentPLLFreq = fHRCK; // 絋玂 fHRCK タ絋璸衡㎝﹚竡
		...
		// 陪ボ繵瞯玂痙ㄢ计
		char freqStr[10];
		sprintf(freqStr, "%.2f", currentPWMFreq / 1000.0f); // ㄒ "100.00KHz"
		
		// 睲埃Τ陪ボ跋办沮惠璶秸俱フ才计秖
		//OLED_ShowStr(45, 2, "		 ", 2); //  (45,2) 竚睲埃Τ陪ボ
		// 陪ボ穝繵瞯
		OLED_ShowStr(45, 2, freqStr, 2); //  (45,2) 竚陪ボ讽玡繵瞯
    ...
    else
    {
		...
		//OLED_ShowStr(50, 6, "	     ", 2); // 睲埃Τ陪ボ
		//OLED_ShowStr(30, 6, " STOP   ", 2);   // 陪ボ家Α跑
		...
		//OLED_ShowStr(45, 2, "		 ", 2); // 睲埃Τ陪ボ
		OLED_ShowStr(45, 2, freqStr, 2); // 陪ボ讽玡繵瞯
